...
struct QuoteRequestScreen: View {
    ...
    /// True while the lead record is being saved after the Messages send.
    /// The SMS is already out at this point — this gates the /l reply link.
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            if !trimmedReq.isEmpty {
                ...
                if !alreadyAsked {
                    editableRequest = trimmedReq + " Can you take this on? Please reply to this text with your estimate and availability. Thank you!"
                }
            }
