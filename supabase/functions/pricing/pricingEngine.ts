...
export const JOB_TYPE_TAXONOMY: JobTypeEntry[] = [
  ...
  { job_type: "carpentry.wood_rot", category: "Carpentry", keywords: ["wood rot", "dry rot", "rotted trim", "rotten trim", "rotted siding", "rotted sill", "fascia rot", "soffit rot", "rotting wood"], trade: "framing", itemId: "wood-rot-repair", unit: "project", defaultQuantity: 1, priority: 1 },
